...
describe("NFTMarket", function() {
  it("Should create and execute market sales", async function() {
    ...
    /* create two tokens */
    await nftMarketplace.createToken("https://www.mytokenlocation.com", listingPrice, { value: listingPrice })
    await nftMarketplace.createToken("https://www.mytokenlocation2.com", listingPrice, { value: listingPrice })
